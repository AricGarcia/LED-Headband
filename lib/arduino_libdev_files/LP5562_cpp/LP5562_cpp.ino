...
*/
uint16_t LP5562::waitCMD(uint8_t prescale, uint8_t waittime)
{
  uint16_t command = 0;
  command |= prescale << 14;
  command |= waittime << 8;
...
*/
uint16_t LP5562::setPwmCMD(uint8_t pwm)
{
...
*/
uint16_t LP5562::branchCMD(uint8_t loop_cnt, uint8_t step_num)
{
...
*/
uint16_t LP5562::endCMD(uint8_t send_interupt, uint8_t reset)
{
...
*/
uint16_t LP5562::triggerCMD(uint8_t send_trigger, uint8_t wait_trigger)
{
